    ...
    class NVActivityIndicatorAnimationOrbit: NVActivityIndicatorAnimationDelegate {
        ...
        func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
            ...
            self.ring1InLayer(layer, size: size, color: color)
            self.ring2InLayer(layer, size: size, color: color)
            self.coreInLayer(layer, size: size, color: color)
            self.satelliteInLayer(layer, size: size, color: color)
        }
        ...
        func ring1InLayer(_ layer: CALayer, size _: CGSize, color: UIColor) {
            ...
            // Draw circle
            let circle = NVActivityIndicatorShape.circle.layerWith(size: CGSize(width: self.coreSize, height: self.coreSize), color: color)
            let frame = CGRect(
                x: (layer.bounds.size.width - self.coreSize) / 2,
        ...
        func satelliteInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
            ...
            rotateAnimation.path = UIBezierPath(
            ...
            // Draw circle
            let circle = NVActivityIndicatorShape.circle.layerWith(size: CGSize(width: self.satelliteSize, height: self.satelliteSize), color: color)
